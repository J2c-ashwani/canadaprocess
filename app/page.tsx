    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <>
              ...
              <div className="grid gap-6 sm:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-500 bg-white group hover:-translate-y-2">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardDescription className="text-slate-600 leading-relaxed text-sm sm:text-base">
                      Expert assistance with USA & Canadian government grants and funding programs for startups and
                      small businesses, including application preparation and compliance management.
                    </CardDescription>
                  </CardHeader>
                ...
                <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-500 bg-white group hover:-translate-y-2">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardDescription className="text-slate-600 leading-relaxed text-sm sm:text-base">
                      Comprehensive SEO services, Google Ads management, and digital marketing strategies to increase
                      your online visibility and drive qualified traffic to your website.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <ul className="space-y-3 text-sm text-slate-600">
          ...
          <section className="w-full py-12 sm:py-16 md:py-20 lg:py-32 bg-gray-50 animate-slideInLeft">
            <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
              <div className="grid gap-8 sm:gap-12 lg:gap-16 lg:grid-cols-2 items-center">
                <div className="space-y-6 sm:space-y-8">
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4 sm:mb-6 text-balance leading-tight">
                    Why Canadian Businesses Choose
                    <span className="block bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent mt-1 break-words">
                      FSI Digital for Web Development
                    </span>
                  </h2>
                  <p className="text-base sm:text-lg md:text-xl text-slate-600 mb-6 sm:mb-8 leading-relaxed text-pretty px-2 sm:px-0">
                    As a leading web development company in Canada, we don't just build websites - we create
                    comprehensive digital solutions that drive measurable business growth. Our proven approach combines
                    cutting-edge web development with strategic digital marketing to deliver exceptional ROI for
                    startups, small businesses, and enterprises across Toronto, Vancouver, Montreal, and beyond.
                  </p>
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-start space-x-3 sm:space-x-4 p-2 sm:p-3">
                      <div className="flex-shrink-0 bg-gradient-to-br from-teal-500 to-teal-600 p-2.5 sm:p-3 rounded-xl shadow-lg mt-0.5">
                        <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-white" />
                      </div>
                      <div className="flex-1 min-w-0 pr-2 sm:pr-4">
                        <h3 className="font-bold text-slate-900 text-base sm:text-lg mb-1 sm:mb-2 text-balance">
                          Proven Track Record
                        </h3>
                        <p className="text-slate-600 text-sm sm:text-base leading-relaxed text-pretty break-words hyphens-auto">
                          500+ successful website projects with measurable ROI and sustained business growth for
                          Canadian clients across all industries.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 sm:space-x-4 p-2 sm:p-3">
                      <div className="flex-shrink-0 bg-gradient-to-br from-blue-500 to-blue-600 p-2.5 sm:p-3 rounded-xl shadow-lg mt-0.5">
                    ...
                    <div className="flex items-start space-x-3 sm:space-x-4 p-2 sm:p-3">
                      <div className="flex-shrink-0 bg-gradient-to-br from-amber-500 to-amber-600 p-2.5 sm:p-3 rounded-xl shadow-lg mt-0.5">
                      ...
                      <div className="flex-1 min-w-0 pr-2 sm:pr-4">
                        ...
                        <p className="text-slate-600 text-sm sm:text-base leading-relaxed text-pretty break-words hyphens-auto">
                          From custom web development and SEO to digital marketing and government grants - everything
                          you need to succeed online under one roof.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3 sm:space-x-4 p-2 sm:p-3">
                      <div className="flex-shrink-0 bg-gradient-to-br from-slate-500 to-slate-600 p-2.5 sm:p-3 rounded-xl shadow-lg mt-0.5">
                  ...
                  <div className="pt-2 sm:pt-4">
                    <Button
                      className="bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 text-white px-6 sm:px-8 py-4 text-base sm:text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 w-full sm:w-auto min-h-[48px] rounded-xl"
                      asChild
                    >
                ...
                <div className="relative order-first lg:order-last">
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 via-blue-500/10 to-slate-500/10 rounded-2xl sm:rounded-3xl blur-2xl"></div>
                  <Image
                    alt="Canadian web development team creating custom websites"
                    className="relative rounded-2xl sm:rounded-3xl object-cover shadow-2xl border border-slate-200 w-full h-[200px] xs:h-[250px] sm:h-[300px] md:h-[350px] lg:h-[500px] xl:h-[600px]"
                    height={600}
              ...
              <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
                ...
                <Card className="border-0 shadow-lg bg-white hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-6 sm:p-8">
                    ...
                    <blockquote className="text-slate-700 mb-6 sm:mb-8 italic text-base sm:text-lg leading-relaxed">
                      "The quality and attention to detail exceeded our expectations. Our new e-commerce website not
                      only looks premium but performs exceptionally well with fast loading times."
                    </blockquote>
                    <div className="flex items-center">
                ...
                <Card className="border-0 shadow-lg bg-white hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-6 sm:p-8">
                    ...
                    <blockquote className="text-slate-700 mb-6 sm:mb-8 italic text-base sm:text-lg leading-relaxed">
                      "Professional, strategic, and results-driven web development. They delivered exactly what we
                      needed and more. Our online presence and SEO rankings have never been stronger."
                    </blockquote>
                    <div className="flex items-center">
